...
- `/profile` — Profile page with tagline + three placeholder section cards: "What I've Studied" (from `studied`), "How I Learn" (from `how_i_learn`), "Where I'm Heading" (extracted goals portion of `how_i_learn`). Currently placeholder copy — endpoint fields don't exist yet, awaiting backend changes.
